...
class OpportunityRecord(Base):
    ...
    calls_30d: Mapped[int] = mapped_column(Integer, default=0)
    unique_payers_30d: Mapped[int] = mapped_column(Integer, default=0)
    estimated_volume_30d_usd: Mapped[float] = mapped_column(Float, default=0)
